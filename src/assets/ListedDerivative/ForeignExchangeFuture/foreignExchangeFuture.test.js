...
describe('ForeignExchangeFuture', () => {
    describe('constructor', () => {
        ...
        it('should set references correctly', () => {
            ...
            const testCommodityFuture = new ForeignExchangeFuture({ assetId: 'assetId', references })
        ...
        it('should stringify correctly', () => {
            const testCommodityFuture = new ForeignExchangeFuture({ assetId: 'testId', issueDate: '2017-08-02'})
